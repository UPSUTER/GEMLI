...
```
> visualize_as_network(GEMLI_items, cutoff=90, ground_truth=T, highlight_FPs=F) # top image
> visualize_as_network(GEMLI_items, cutoff=50, ground_truth=T, highlight_FPs=F) # lower image
```
<p float="left">
