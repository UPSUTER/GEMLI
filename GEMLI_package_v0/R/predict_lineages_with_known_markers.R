predict_lineages_with_known_markers <- function(GEMLI_items, repetitions=100, sample_size=(2/3), lineage_size=c(2,3), fast=FALSE)
{
  ...
  for (i in seq(1,repetitions))
  {
    ...
    smallest_clusters = names(clustersize_dict)[clustersize_dict %in% lineage_size]
